...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  var one = sum(sum(a,b)[0],c)[0];
  var two = multiply(multiply(a,b)[0],c)[0];
  var messageOne = a + ' and ' + b + ' and ' + c + ' sum to ' + one + '.';
  var messageTwo = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + two + '.';
  console.log(messageOne, messageTwo);
  return [one, two, messageOne, messageTwo];
}
